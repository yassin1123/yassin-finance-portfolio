...
const stats = [
  { value: 1, suffix: '+', label: 'Years Experience', isNumeric: true },
  { value: 6, suffix: '+', label: 'Financial Models', isNumeric: true },
  { value: 5, suffix: '', label: 'Sectors Covered', isNumeric: true },
